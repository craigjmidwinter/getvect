...
`fixtures/reference/artwork.png` is a raster source (1045×833 artwork, flat-color character
on a busy background) and `fixtures/reference/artwork.svg` is **the actual output
