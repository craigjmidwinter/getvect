...
![The prompt experiment that proved it: 'convert into a flat vector graphic' beats describing the operations — the style name carries the whole contract](media/snorlax-gemini-vector-prompt.png)
...
vectorizer on the snorlax?" — and the answer turned out to be that we'd been
